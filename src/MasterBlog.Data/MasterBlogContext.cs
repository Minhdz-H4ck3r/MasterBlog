using MasterBlog.Core.Domain.Content;
...
{
    public class MasterBlogContext:IdentityDbContext<AppUser,AppRole,Guid>
    {
        ...
        public DbSet<PostlnSeries> PostInSeries { get; set; }
        ...
        public override Task<int> SaveChangesAsync(bool acceptAllChangesOnSuccess, CancellationToken cancellationToken = default)
        {
            ...
            foreach (var entityEntry in entries)
            {
                ...
                var modifiedDateProp = entityEntry.Entity.GetType().GetProperty("modifiedDateProp");
